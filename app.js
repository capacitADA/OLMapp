    ...
    showModal(`<div class="modal modal-wide" onclick="event.stopPropagation()">
        ...
        <div class="modal-b">
            ...
            <div class="fr">
                ...
                <div><label class="fl">Hora salida</label><input class="fi" type="time" id="jHSalida"></div>
            </div>
            <div class="fr">
            ...
            <div class="fr">
                ...
                <div><label class="fl">SAP</label><input class="fi" id="jFuncSAP"></div>
            </div>
            <label class="fl">Firma funcionario tienda (con el dedo)</label>
            <canvas id="jFirmaCanvas" width="300" height="80" style="width:100%;height:80px;border:1.5px dashed var(--green);border-radius:8px;background:#f0faf5;touch-action:none;cursor:crosshair;display:block;"></canvas>
...
td,th{border:1px solid #555;padding:2px 4px;font-size:7.5px;vertical-align:top;}
